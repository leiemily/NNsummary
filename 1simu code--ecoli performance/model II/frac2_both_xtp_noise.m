...
choose_number = 4;
%%
load(['frac2-',num2str(choose_number),'tp-step1']);
...
%%
load(['frac2-',num2str(choose_number),'tp-mix1']);
num_sin1 = 1:8;%前8/10
...
%%
save(['frac2-',num2str(choose_number),'tp-both1-noise'],'aS_save2','aF_save2','adsdt_save2','adFdt_save2',...
