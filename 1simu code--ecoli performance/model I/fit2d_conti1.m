function [err2,F_pre1,dF2_train1] = fit2d_conti1(simu2,discreteT_length,Numberof_F,t00,t_scale,F_save,dFdt_save,dF2dt2_save,ds2dt2_save,Fi,Fj,repeat_number,plot_number)
...
if plot_number == 1
    for i = 1:Numberof_F
        ...
        subplot(Fi,Fj,i);
    % %     plot(t1,dF2dt2_save(i,:),'k-','linewidth',1);hold on
