...
Numberof_Tp = 4;
% dt00 = 0.2;
load('frac1-10tp-mix1.mat','t_scale','dt00');
%% noise level
...
Tp = 10*[unifrnd(1,2,Numberof_F,1),unifrnd(1,2,Numberof_F,1),unifrnd(2,3,Numberof_F,1),unifrnd(2,3,Numberof_F,1)];
% load('frac1-10tp-mix1.mat','S_para','Tp');
%% parameters
kR = 3.82e-2;
kBp = 3.25;
...
for i = 1:Numberof_F
    %%
    s = linearexpcom_s(S_para(i,:),Tp(i,:),t00,step_maxvalue);
...
%% noise and smooth noise and smooth  noise and smooth  noise and smooth  noise and smooth  noise and smooth  noise and smooth 
...
for i = 1:Numberof_F
    ...
    F_noise = F + noise_F;
    %% constraint F_noise
    F_overnn = find(F_noise<0| F_noise>1);
...
%     error_noisef(i) = norm(F_save(i,:) - Fsmooth_save(i,:),2)/norm(F_save(i,:),2);
...
%%
save('frac1-10tp-expmix1.mat','nl_snr','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
