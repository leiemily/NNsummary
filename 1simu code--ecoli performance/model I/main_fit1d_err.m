...
trainsetName0 = ['frac1-',num2str(j),'tp-save1d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['frac1-',num2str(j),'tp-test1d-noise'];
...
%%
datasetName0 = ['frac1-',num2str(j),'tp-both1-noise'];
load(fullfile(folderPath_varieddata, datasetName0),'S_lin','F_lin');
simu1 = Y_surf1;
fit_Gsurfaces;

%%
datasetName1 = ['frac1-',num2str(j),'tp-step1'];
...
%%
datasetName2 = ['frac1-',num2str(j),'tp-mix1'];
load(fullfile(folderPath_varieddata, datasetName2));
simu_mix = Y_all2;
repeat_number2 = 2;
[err2,F_pre1,dF_train1] = fit1d_conti1(simu_mix,discreteT_length,Numberof_F,t00,t_scale,...
...
%%
datasetName3 = ['frac1-',num2str(j),'tp-expmix1'];
load(fullfile(folderPath_varieddata, datasetName3));
simu_expcos = Y_all3;
repeat_number3 = 3;
[err3,F_pre1,dF_train1] = fit1d_conti1(simu_expcos,discreteT_length,Numberof_F,t00,t_scale,...
    Fsmooth_save,dFdtsmooth_save,dsdt_save,Numberof_F/2,2,repeat_number3,plot_number);
...
%%
datasetName4 = ['frac1-',num2str(j),'tp-gauss1'];
load(fullfile(folderPath_varieddata, datasetName4));
simu_gauss = Y_all4;
repeat_number4 = 4;
[err4,F_pre1,dF_train1] = fit1d_conti1(simu_gauss,discreteT_length,Numberof_F,t00,t_scale,...
