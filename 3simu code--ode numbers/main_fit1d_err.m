...
trainsetName0 = ['frac2-',num2str(j),'tp-save1d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['frac2-',num2str(j),'tp-test1d-noise'];
...
%%
datasetName0 = ['frac2-',num2str(j),'tp-both1-noise'];
...
simu_step = Y_all1;
repeat_number1 = 1;
[err1,F_pre1,dF_train1] = fit1d_disconti1(simu_step,Length2,Numberof_F,t_scale,T_save2,...
    Fsmooth_save2,dFdtsmooth_save2,dsdt_save2,Numberof_F/2,2,repeat_number1,plot_number);
...
dF_step = dFdtsmooth_save2(num_train_set1)/t_scale;
%%
datasetName2 = ['frac2-',num2str(j),'tp-mix1'];
load(fullfile(folderPath_varieddata, datasetName2));
simu_mix = Y_all2;
repeat_number2 = 2;

[err2,F_pre2,dF_pre2,second_term_test2,dF_train2] = fit1d_conti1(simu_mix,discreteT_length,Numberof_F,t00,t_scale,...
    Fsmooth_save,dFdtsmooth_save,dsdt_save,Numberof_F/2,2,repeat_number2,plot_number);
...
train_set2 = 1:8;
dFtrain_mix = reshape(dF_train2(train_set2,:)',[1,length(train_set2)*discreteT_length]);
dF_mix = reshape(dFdtsmooth_save(train_set2,:)',[1,length(train_set2)*discreteT_length])/t_scale;

%%
datasetName3 = ['frac2-',num2str(j),'tp-expmix1'];
...
[err3,F_pre3,dF_pre3,second_term_test3,dF_train3] = fit1d_conti1(simu_expcos,discreteT_length,Numberof_F,t00,t_scale,...
    Fsmooth_save,dFdtsmooth_save,dsdt_save,Numberof_F/2,2,repeat_number3,1);
...
%%
datasetName4 = ['frac2-',num2str(j),'tp-gauss1'];
load(fullfile(folderPath_varieddata, datasetName4));
simu_gauss = Y_all4;
repeat_number4 = 4;

[err4,F_pre4,dF_pre4,second_term_test4,dF_train4] = fit1d_conti1(simu_gauss,discreteT_length,Numberof_F,t00,t_scale,...
    Fsmooth_save,dFdtsmooth_save,dsdt_save,Numberof_F/2,2,repeat_number4,plot_number);

test_set4 = 1:4;
S_save_gauss = S_save;
second_pre_gauss = second_term_test4;
dF_pre_gauss = dF_pre4;
F_pre_gauss = F_pre4;
...
save(savePath,'test_set1','test_error1','err1','t00_step','Fnoise_step','F_step','F_pre_step','S_save_step',...
    'Range_step','-append');
save(savePath,'test_set2','test_error2','err2','t00_mix','Fnoise_mix','F_mix','F_pre_mix','S_save_mix',...
    'Range_mix','second_pre_mix','dF_pre_mix','-append');
save(savePath,'test_set3','test_error3','err3','t00_expcos','Fnoise_expcos','F_expcos','F_pre_expcos','S_save_expcos',...
    'Range_expcos','second_pre_expcos','dF_pre_expcos','-append');
save(savePath,'test_set4','test_error4','err4','t00_gauss','Fnoise_gauss','F_gauss','F_pre_gauss','S_save_gauss',...
    'Range_gauss','second_pre_gauss','dF_pre_gauss','-append');
