...
%% noise level
load('frac2-10tp-step1.mat','nl_snr');
...
%% s setting
load('frac2-10tp-step1.mat','S_save','S_para','Tp');
...
%%
save(['frac2-',num2str(stretch_para),'tp-step1'],'nl_snr','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
