...
trainsetName0 = ['frac2-',num2str(j),'tp-save2d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['frac2-',num2str(j),'tp-test2d-noise'];
...
[err2,F_pre2,dF2_pre2,second_term_test2,dF2_train2] = fit2d_conti1(simu_mix,discreteT_length,Numberof_F,t00,t_scale,...
    Fsmooth_save,dFdtsmooth_save,dF2dt2smooth_save,ds2dt2_save,Numberof_F/2,2,repeat_number2,1);
...
[err4,F_pre4,dF2_pre4,second_term_test4,dF2_train4] = fit2d_conti1(simu_gauss,discreteT_length,Numberof_F,t00,t_scale,...
...
%     'Range_gauss','second_pre_gauss','dF2_pre_gauss','-append');
