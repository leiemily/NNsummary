function [err2,F_pre1,dF_pre1,second_term_test1,dF_train1] = fit1d_conti1(simu2,discreteT_length,Numberof_F,t00,t_scale,F_save,dFdt_save,dsdt_save,Fi,Fj,repeat_number,plot_number)

dF_pre1 = reshape(simu2(:,1),[discreteT_length Numberof_F])'/t_scale;
F_pre1 = reshape(simu2(:,2),[discreteT_length Numberof_F])';

g2_test1 = reshape(simu2(:,4),[discreteT_length Numberof_F])';
second_term_test1 = g2_test1.*dsdt_save/t_scale;

g1_train1 = reshape(simu2(:,5),[discreteT_length Numberof_F])';
g2_train1 = reshape(simu2(:,6),[discreteT_length Numberof_F])';
dF_train1 = g1_train1 + g2_train1.*dsdt_save;

second_term_train1 = g2_train1.*dsdt_save/t_scale;
