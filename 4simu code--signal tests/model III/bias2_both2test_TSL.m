clear;
%%
load('bias2-1tp-step1.mat');
num_step1 = 1:4004;%前4/
S_step1 = S_save2(num_step1);
F_step1 = F_save2(num_step1);
dsdt_step1 = dsdt_save2(num_step1);
dFdt_step1 = dFdt_save2(num_step1);
ds2dt2_step1 = zeros(1,length(num_step1));
dF2dt2_step1 = dF2dt2_save2(num_step1);

%%
load('bias2-1tp-trapz1.mat');
num_trapz1 = 1:4004;%前4/
...
dF2dt2_sin1 = dF2dt21;
%%
aS_save2 = [S_step1,S_trapz1,S_sin1];
aF_save2 = [F_step1,F_trapz1,F_sin1];
adsdt_save2 = [dsdt_step1,dsdt_trapz1,dsdt_sin1];
adFdt_save2 = [dFdt_step1,dFdt_trapz1,dFdt_sin1];
ads2dt2_save2 = [ds2dt2_step1,ds2dt2_trapz1,ds2dt2_sin1];
adF2dt2_save2 = [dF2dt2_step1,dF2dt2_trapz1,dF2dt2_sin1];
%% s f
S_lin = 0:0.04:2; Ls = length(S_lin);
F_lin = 0:0.02:1; LF = length(F_lin);
[aF1,aS1] = meshgrid(F_lin,S_lin);
%%
save('bias2-1tp-both1-freeTSL.mat','aS_save2','aF_save2','adsdt_save2','adFdt_save2',...
