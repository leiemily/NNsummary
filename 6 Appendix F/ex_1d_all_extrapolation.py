...
def pred1_f(internal_period, total_epoch, mat_file_path, llsi, test_trajectory_numbers):#two-point central diff(1-diff)
    ...
    for n in range(model_number + 1):
        ...
        model.restore("my1dfreeModel/1dfree_model.ckpt-" + str(model_number_n), verbose=1)
...
checkpointer = dde.callbacks.ModelCheckpoint(
     "my1dfreeModel/1dfree_model.ckpt", verbose=1, save_better_only=False,period=internal_period,
 )

losshistory, train_state = model.train(epochs=0, model_save_path = "my1dfreeModel/1dfree_model.ckpt")

losshistory, train_state = model.train(epochs=total_epoch,
                                       display_every=internal_period,
                                       callbacks=[checkpointer],
                                       model_restore_path = "my1dfreeModel/1dfree_model.ckpt-0")
...
array_names0 = ['ep_number','test_error1', 'Y_all1', 'test_error2', 'Y_all2','test_error3', 'Y_all3','Y_surf1']
mat_dict0 = {name: array for name, array in zip(array_names0, [ep_number,test_error1, Y_all1, test_error2, Y_all2, 
                                                             test_error3, Y_all3, Y_surf1])}
savemat('frac2-10tps-save1d-free.mat', mat_dict0)
savemat('frac2-10tpt-save1d-free.mat', mat_dict0)
...
savemat('frac2-12tps-save1d-free.mat', s_up_mat_dict1)
savemat('frac2-14tps-save1d-free.mat', s_up_mat_dict2)
savemat('frac2-16tps-save1d-free.mat', s_up_mat_dict3)
savemat('frac2-18tps-save1d-free.mat', s_up_mat_dict4)
savemat('frac2-20tps-save1d-free.mat', s_up_mat_dict5)
savemat('frac2-22tps-save1d-free.mat', s_up_mat_dict6)
savemat('frac2-24tps-save1d-free.mat', s_up_mat_dict7)
...
savemat('frac2-12tpt-save1d-free.mat', s_left_mat_dict1)
savemat('frac2-14tpt-save1d-free.mat', s_left_mat_dict2)
savemat('frac2-16tpt-save1d-free.mat', s_left_mat_dict3)
savemat('frac2-18tpt-save1d-free.mat', s_left_mat_dict4)
savemat('frac2-20tpt-save1d-free.mat', s_left_mat_dict5)
...
savemat('frac2-22tpt-save1d-free.mat', s_right_mat_dict1)
savemat('frac2-24tpt-save1d-free.mat', s_right_mat_dict2)
savemat('frac2-26tpt-save1d-free.mat', s_right_mat_dict3)
savemat('frac2-28tpt-save1d-free.mat', s_right_mat_dict4)
savemat('frac2-30tpt-save1d-free.mat', s_right_mat_dict5)
