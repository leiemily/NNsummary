...
%% s setting
load('frac2-10tpb-expmix1.mat','S_save1uncut','S_para','Tp','per');
step_maxvalue = 2;

%% x tp
load('frac2-10tpb-mix1','t_scale','dt00');
delta_s_para = 1.4;
...
dt10 = dt00/t_scale;
%% save space
S_save = S_save1uncut + delta_s_para;
...
%%
save(['frac2-',num2str(10*(1+delta_s_para)),'tps-expmix1'],'per','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
