...
Numberof_Tp = 4;
load('frac2-10tpb-mix1.mat','t_scale','dt00');
...
% Tp = 9*[unifrnd(1,2,Numberof_F,1),unifrnd(1,2,Numberof_F,1),unifrnd(2,3,Numberof_F,1),unifrnd(2,3,Numberof_F,1)];
...
%%
save('frac2-10tpb-expmix1.mat','per','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
