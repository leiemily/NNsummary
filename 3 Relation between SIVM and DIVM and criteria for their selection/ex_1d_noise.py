...
def gen_traindata():
    data = scipy.io.loadmat('dataset/frac2-9tp-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/frac2-9tp-both1-noise.mat')
...
mat_file_path1 = 'dataset/frac2-9tp-step1.mat'
llsi = 11
...
savemat('frac2-9tp-save1d-noise.mat', mat_dict)# 保存字典到.mat文件