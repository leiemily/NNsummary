...
def gen_traindata():
    data = scipy.io.loadmat('dataset/exp1-0tp-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/exp1-0tp-both1-noise.mat')
...
savemat('exp1-0tp-save2d-noise.mat', mat_dict)# 保存字典到.mat文件
