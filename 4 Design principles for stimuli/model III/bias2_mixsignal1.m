...
%% s setting
rng("shuffle");
S_para = 0.2*unifrnd(3,5.5,Numberof_F,Numberof_Tp);
...
%%
save('bias2-1tp-mix1.mat','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
    'S_para','Tp','m_save','FliM_save','Fs_save',...
