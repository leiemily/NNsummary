...
def gen_traindata():
    data = scipy.io.loadmat('dataset/bias2-1tp-both1-freeL.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/bias2-1tp-both1-freeL.mat')
...
test_trajectory_number1 = 8
test_trajectory_number2 = 8
test_trajectory_number3 = 8

"""L,T-S
test_trajectory_number1 = 16
test_trajectory_number2 = 10
test_trajectory_number3 = 8"""

"""L,S-T
test_trajectory_number1 = 10
test_trajectory_number2 = 16
test_trajectory_number3 = 8"""

"""L-T,S
test_trajectory_number1 = 16
test_trajectory_number2 = 16
test_trajectory_number3 = 2"""

mat_file_path1 = 'dataset/bias2-1tp-step1.mat'
llsi = 11
test_error1, Y_all1 = pred1_f(internal_period, total_epoch, mat_file_path1,llsi,test_trajectory_number1)

mat_file_path2 = 'dataset/bias2-1tp-trapz1.mat'
llsi = 12
test_error2, Y_all2 = pred1_f(internal_period, total_epoch, mat_file_path2,llsi,test_trajectory_number2)

mat_file_path3 = 'dataset/bias2-1tp-mix1.mat'
...
plt.figure()
plt.subplot(1, 3, 1)
#plt.plot(ep_number, test_error1)
...
array_names = ['ep_number','test_error1', 'Y_all1', 'test_error2', 'Y_all2','test_error3', 'Y_all3']# 定义要保存的数组的名称
mat_dict = {name: array for name, array in zip(array_names, [ep_number,test_error1, Y_all1, test_error2, Y_all2, test_error3, Y_all3])}# 将数组和名称组合成一个字典

savemat('bias2-1tp-save2d-freeL.mat', mat_dict)# 保存字典到.mat文件