...
trainsetName0 = ['bias2-',num2str(j),'tp-save2d-freeTS'];
load(fullfile(folderPath_NNdata, trainsetName0));
testsetName0 = ['bias2-',num2str(j),'tp-test2d-freeTS'];
savePath = fullfile(folderPath_NNdata, testsetName0);

% trainsetName0 = ['bias2-',num2str(j),'tp-save2d-freeTSL'];
% load(fullfile(folderPath_NNdata, trainsetName0));
% testsetName0 = ['bias2-',num2str(j),'tp-test2d-freeTSL'];
% savePath = fullfile(folderPath_NNdata, testsetName0);

% trainsetName0 = ['bias2-',num2str(j),'tp-save2d-freeLT'];
% load(fullfile(folderPath_NNdata, trainsetName0));
% testsetName0 = ['bias2-',num2str(j),'tp-test2d-freeLT'];
% savePath = fullfile(folderPath_NNdata, testsetName0);

% trainsetName0 = ['bias2-',num2str(j),'tp-save2d-freeLS'];
% load(fullfile(folderPath_NNdata, trainsetName0));
% testsetName0 = ['bias2-',num2str(j),'tp-test2d-freeLS'];
% savePath = fullfile(folderPath_NNdata, testsetName0);

% trainsetName0 = ['bias2-',num2str(j),'tp-save2d-freeL'];
% load(fullfile(folderPath_NNdata, trainsetName0));
% testsetName0 = ['bias2-',num2str(j),'tp-test2d-freeL'];
% savePath = fullfile(folderPath_NNdata, testsetName0);
%% test errs
Fi = 2;
Fj = 2;
...
%%
datasetName2 = ['bias2-',num2str(j),'tp-trapz1'];
load(fullfile(folderPath_varieddata, datasetName2));
simu_trapz = Y_all2;
repeat_number2 = 2;
[err2,F_pre2,dF2_train2] = fit2d_disconti1(simu_trapz,Length2,Numberof_F,t_scale,T_save2,...
...
%%
datasetName3 = ['bias2-',num2str(j),'tp-mix1'];
...
[err3,F_pre3,dF2_pre3,second_term_test3,dF2_train3] = fit2d_conti1(simu_mix,discreteT_length,Numberof_F,t00,t_scale,...
    F_save,dFdt_save,dF2dt2_save,ds2dt2_save,Numberof_F/4,4,repeat_number3,1);
...
save(savePath,'test_set1','test_error1','err1','t00_step','Ffree_step','F_step','F_pre_step','S_save_step',...
    'Range_step','-append');
save(savePath,'test_set2','test_error2','err3','t00_trapz','Ffree_trapz','F_trapz','F_pre_trapz','S_save_trapz',...
    'Range_trapz','-append');
save(savePath,'test_set3','test_error3','err2','t00_mix','Ffree_mix','F_mix','F_pre_mix','S_save_mix',...
