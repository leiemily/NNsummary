...
%% s setting
rng("shuffle");
S_para = 0.055*unifrnd(3,5,Numberof_F,Numberof_Tp);
...
%%
save('frac1-1tp-mix1.mat','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
    'S_para','Tp','m_save','Yp_save',...
