...
def gen_traindata():
    data = scipy.io.loadmat('dataset/frac2-1tp-both1-freeL.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/frac2-1tp-both1-freeL.mat')
...
savemat('frac2-1tp-save2d-freeL.mat', mat_dict)# 保存字典到.mat文件