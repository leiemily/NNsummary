...
Numberof_Tp = 4;
% dt00 = 0.2;
load('frac2-10tpn-mix1.mat','t_scale','dt00');

%% noise level
load('frac2-10tpn-expmix1.mat','nl_snr');
% nl_snr = unifrnd(20,22,1,Numberof_F);
snr_linear = 10.^(nl_snr/10);% 将SNR转换为线性比例

%% s setting
load('frac2-10tpn-expmix1.mat','S_para','Tp','per');
step_maxvalue = 2;
% rng("shuffle");
...
%%
save('frac2-10tpn-expmix1.mat','nl_snr','per','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
