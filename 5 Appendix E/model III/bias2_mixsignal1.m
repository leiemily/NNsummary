...
%% s setting
% rng("shuffle");
% S_para = 0.2*unifrnd(3,5,Numberof_F,Numberof_Tp);
% Tp = [unifrnd(25,40,Numberof_F,1),unifrnd(45,70,Numberof_F,1)];

load('bias2-10tp-mix1.mat','S_para','Tp');
...
p_smooth = 0.02*ones(1,Numberof_F);
...
%%
save('bias2-10tpn-mix1.mat','nl_snr','t_scale','Numberof_F','Numberof_Tp','discreteT_length','dt00','t00',...
    'S_para','Tp','p_smooth','m_save','FliM_save',...
