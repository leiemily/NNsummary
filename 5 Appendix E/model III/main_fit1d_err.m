...
trainsetName0 = ['bias2-',num2str(j),'tpn-save1d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['bias2-',num2str(j),'tpn-test1d-noise'];
...
%%
datasetName0 = ['bias2-',num2str(j),'tpn-both1-noise'];
load(fullfile(folderPath_varieddata, datasetName0),'S_lin','F_lin');
simu1 = Y_surf1;
fit_Gsurfaces;

%%
datasetName1 = ['bias2-',num2str(j),'tpn-step1'];
...
[err1,F_pre1,dF_train1] = fit1d_disconti1(simu_step,Length2,Numberof_F,t_scale,T_save2,...
    F_save2,dFdt_save2,dsdt_save2,Numberof_F/2,2,repeat_number1,plot_number);
...
dF_step = dFdt_save2(num_train_set1)/t_scale;
%%
datasetName2 = ['bias2-',num2str(j),'tpn-mix1'];
...
[err2,F_pre1,dF_train1] = fit1d_conti1(simu_mix,discreteT_length,Numberof_F,t00,t_scale,...
    F_save,dFdt_save,dsdt_save,Numberof_F/2,2,repeat_number2,plot_number);
...
dF_mix = reshape(dFdt_save(train_set2,:)',[1,length(train_set2)*discreteT_length])/t_scale;

%%
datasetName3 = ['bias2-',num2str(j),'tpn-expmix1'];
...
save(savePath,'test_set1','test_error1','err1','t00_step','F_step','F_pre_step','S_save_step','Range_step','-append');
save(savePath,'test_set2','test_error2','err2','t00_mix','F_mix','F_pre_mix','S_save_mix','Range_mix','-append');
save(savePath,'test_set3','test_error3','err3','t00_expcos','F_expcos','F_pre_expcos','S_save_expcos','Range_expcos','-append');
