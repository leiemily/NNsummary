...
def gen_traindata():
    data = scipy.io.loadmat('dataset/frac1-10tpn-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/frac1-10tpn-both1-noise.mat')
...
mat_file_path1 = 'dataset/frac1-10tpn-step1.mat'
llsi = 11
...
savemat('frac1-10tpn-save2d-noise.mat', mat_dict)# 保存字典到.mat文件
