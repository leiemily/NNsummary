...
trainsetName0 = ['frac1-',num2str(j),'tpn-save1d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['frac1-',num2str(j),'tpn-test1d-noise'];
...
%%
datasetName0 = ['frac1-',num2str(j),'tpn-both1-noise'];
load(fullfile(folderPath_varieddata, datasetName0),'S_lin','F_lin');
simu1 = Y_surf1;
fit_Gsurfaces;

%%
datasetName1 = ['frac1-',num2str(j),'tpn-step1'];
...
%%
datasetName2 = ['frac1-',num2str(j),'tpn-mix1'];
...
%%
datasetName3 = ['frac1-',num2str(j),'tpn-expmix1'];
