...
trainsetName0 = ['exp2-',num2str(j),'tp-save2d-noise'];
load(fullfile(folderPath_NNdata, trainsetName0));

testsetName0 = ['exp2-',num2str(j),'tp-test2d-noise'];
...
vali_all = [F_trapz_vali,F_mix_vali];
valipre_all = [Fpre_trapz_vali,Fpre_mix_vali];
