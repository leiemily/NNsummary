...
def gen_traindata():
    data = scipy.io.loadmat('dataset/frac2-10tp-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/frac2-10tp-both1-noise.mat')
...
mat_file_path1 = 'dataset/frac2-10tp-step1.mat'
llsi = 11
...
mat_file_path2 = 'dataset/frac2-10tp-mix1.mat'
test_trajectory_number2 = 2
test_error2, Y_all2 = pred2_f(internal_period, total_epoch, mat_file_path2,test_trajectory_number2)

mat_file_path3 = 'dataset/frac2-10tp-expmix1.mat'
test_trajectory_number3 = 4
test_error3, Y_all3 = pred2_f(internal_period, total_epoch, mat_file_path3,test_trajectory_number3)

mat_file_path4 = 'dataset/frac2-10tp-gauss1.mat'
test_trajectory_number4 = 4
test_error4, Y_all4 = pred2_f(internal_period, total_epoch, mat_file_path4,test_trajectory_number4)
...
plt.subplot(2, 2, 4)
plt.plot(ep_number, np.log10(test_error4))
plt.xlabel("epoch")
plt.ylabel("gauss MSE err")
plt.show()


array_names = ['ep_number','test_error1', 'Y_all1', 'test_error2', 'Y_all2','test_error3', 'Y_all3','test_error4', 'Y_all4','Y_surf1']# 定义要保存的数组的名称
mat_dict = {name: array for name, array in zip(array_names, [ep_number,test_error1, Y_all1, test_error2, Y_all2, test_error3, Y_all3, test_error4, Y_all4, Y_surf1])}# 将数组和名称组合成一个字典
savemat('frac2-10tp-save1d-noise.mat', mat_dict)# 保存字典到.mat文件