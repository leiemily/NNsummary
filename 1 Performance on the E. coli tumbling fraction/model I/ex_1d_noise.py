...
def gen_traindata():
    data = scipy.io.loadmat('dataset/frac1-10tp-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/frac1-10tp-both1-noise.mat')
...
mat_file_path1 = 'dataset/frac1-10tp-step1.mat'
llsi = 11
...
array_names = ['ep_number','test_error1', 'Y_all1', 'test_error2',
               'Y_all2','test_error3', 'Y_all3','Y_surf1']# 定义要保存的数组的名称
mat_dict = {name: array for name, array in zip(array_names, [ep_number,test_error1, Y_all1,
                                                             test_error2, Y_all2, 
                                                             test_error3, Y_all3, Y_surf1])}# 将数组和名称组合成一个字典
savemat('frac1-10tp-save1d-noise.mat', mat_dict)# 保存字典到.mat文件