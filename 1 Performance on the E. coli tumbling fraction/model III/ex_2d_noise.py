...
array_names = ['ep_number','test_error1', 'Y_all1', 'test_error2', 'Y_all2',
               'test_error3', 'Y_all3']# 定义要保存的数组的名称
mat_dict = {name: array for name, array in zip(array_names, [ep_number,test_error1, Y_all1,
                                                             test_error2, Y_all2, 
                                                             test_error3, Y_all3])}# 将数组和名称组合成一个字典
savemat('bias2-10tp-save2d-noise.mat', mat_dict)# 保存字典到.mat文件
