...
def gen_traindata():
    data = scipy.io.loadmat('dataset/bias2-10tp-both1-noise.mat')
...
def ex_func(s):
    data2 = scipy.io.loadmat('dataset/bias2-10tp-both1-noise.mat')
...
mat_file_path1 = 'dataset/bias2-10tp-step1.mat'
llsi = 11
...
savemat('bias2-10tp-save1d-noise.mat', mat_dict)# 保存字典到.mat文件